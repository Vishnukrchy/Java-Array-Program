...
public class FindLastOcuuranceOfX {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		  Scanner  sc=new Scanner(System.in);
    		...
    		System.out.println();
    		System.out.println(" Last Ocuurance Of X Index is is : "+chekLastOccurranceOfX(a));
	}
	
	public static int  chekLastOccurranceOfX(int [] a) {
		Scanner sc = new Scanner(System.in);
